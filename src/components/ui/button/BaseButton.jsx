...
export const BaseButton = ({ name, withIcon, iconType }) => {
  return (
    <div>
      <button class="flex text-center items-center group px-8 py-4 rounded-lg border-2 bg-indigo-400 hover:bg-white hover:border-indigo-400">
        <span class="text-white group-hover:text-indigo-400 text-base font-medium">
          {name}
        </span>
        {withIcon && iconType && (
